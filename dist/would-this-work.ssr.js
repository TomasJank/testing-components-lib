...
function kebabToCamel(string) {
  ...
  var converter = function converter(matches) {
    var _matches$;

    return (_matches$ = matches[1]) === null || _matches$ === void 0 ? void 0 : _matches$.toUpperCase();
  };

  var result = string === null || string === void 0 ? void 0 : string.replace(/(-\w)/g, converter);
